...
<body>
	<div class="bbox">
		...
		<div class="bright">
			...
			<center>
				<div class="bit"><h2>修改房间</h2></div>
				<table id="tab" class="tab5">
					<form action="<%=request.getContextPath() %>/AdminHouseServlet?method=houseUpdateByHid" method="post">
						<tr>
							<td>房间号：</td>
							<td><input type="text" name="hid" value="${house.hid }" /></td>
						</tr>
						<tr>
							<td>房间类型：</td>
							<td>
